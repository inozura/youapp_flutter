...
abstract class $LoginResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool? success, String? token, String? error});
}
...
class _$LoginResponseImpl extends _LoginResponse {
  const _$LoginResponseImpl({this.success, this.token, this.error}) : super._();
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, success, token, error);
