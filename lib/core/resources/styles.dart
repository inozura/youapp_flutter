...
ThemeData themeLight(BuildContext context) => ThemeData(
      ...
      extensions: const <ThemeExtension<dynamic>>[
        LzyctColors(
          background: Palette.backgroundTransparent,
          card: Palette.card,
...
class BoxShadows {
  ...
  BoxShadow get button => BoxShadow(
        color:
            Theme.of(context).extension<LzyctColors>()!.sky!.withOpacity(0.5),
        blurRadius: 16.0,
        spreadRadius: 1.0,
      );
